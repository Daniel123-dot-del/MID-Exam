...
class ContactPage extends StatelessWidget {
  final List contactItems = [
    ...
    ContactInfo(Icons.phone, 'Phone', '09519637603 – 09283875420', Colors.red),
    ContactInfo(Icons.location_on, 'Location', '454 GRC BLDG. Rizal Ave. Cor. 9th ave. East Grace Park, Caloocan City 1400 Metro Manila. ', Colors.red),
    ContactInfo(Icons.language, 'Website', 'https://grc.edu.ph/', Colors.red),
  ];
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(height: 20),
                    Text('Contact Us', style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold, color: Colors.black87)),
                    SizedBox(height: 10),
                    Text('Feel free to reach out to Us', style: TextStyle(fontSize: 16, color: Colors.grey[600]), textAlign: TextAlign.center),
                  ],
                ),
              ),
